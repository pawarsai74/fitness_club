<?php
  ...
  class Admin extends BaseController
  {
    ...
    public function dashboard()
    {
      ...
      $builder->orderBy('id', 'DESC')->limit(4);
      $data['members']  = $builder->get()->getResult();
      // echo '<pre>';
      ...
      $data['all_trainer']  = $trainer->findAll();

      $blogs = new BlogsModel();
      $data['all_blogs']  = $blogs->findAll();

      $members = new MembersModel();
      $data['all_members']  = $members->findAll();

      $social = new LoginModel();
      $data['all_social']  = $social->findAll();

      $amenities = new AmenitiesModel();
      $data['all_amenities']  = $amenities->findAll();
